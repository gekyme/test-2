print("для орентации ответов и заданий вам надо выбратиь номер задания, всего заданий 8,введя число 1 - 7 вам выйдет ответ на конкретное задание , но ввидя число 0 код остановиться ")
